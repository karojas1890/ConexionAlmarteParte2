...
def ValidarUsuarioRecovery():
    try:
        ...
        url ="https://conexionalmarteparte2.onrender.com/api/Credenciales/ValidarUsuario"
...
def ValidateSecurityQuestions():
    try:
        ...
        url = "https://conexionalmarteparte2.onrender.com/api/Credenciales/PreguntasSeguridad"
...
def ValidateCode():
    try:
        ...
        url = "https://conexionalmarteparte2.onrender.com/api/Credenciales/ValidarCodigo"
...
def UpdatePassword():
    try:
        ...
        url = "https://conexionalmarteparte2.onrender.com/api/Credenciales/actualizarContrasena"
