...
def ValidarUsuarioRecovery():
    try:
        ...
        url ="http://localhost:3000/api/Credenciales/ValidarUsuario"
...
def ValidateSecurityQuestions():
    try:
        ...
        url = "http://localhost:3000/api/Credenciales/PreguntasSeguridad"
...
def ValidateCode():
    try:
        ...
        url = "http://localhost:3000/api/Credenciales/ValidarCodigo"
...
def UpdatePassword():
    try:
        ...
        url = "http://localhost:3000/api/Credenciales/actualizarContrasena"
